...
server.on('message', function(message, remote) {
   handle_udp_message(message, remote.address);
...
function handle_udp_message(message, sender_address){
	...
	destination_port = PORT + device;
	server.send(ack_packet,destination_port,sender_address,function(error){
  		if(error){
    					client.close();
  		}else{
